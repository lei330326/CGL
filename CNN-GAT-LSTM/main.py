...
parser.add_argument('-dd', "--data_dir", default='./data/data.npz', type=str, help='The data directory')
...
elif "weekly" in args.data_dir or args.data_dir.endswith(".npy") or "data_full.npz" in args.data_dir :  # A bit of a hack to accomodate the previous paper's CNN-RNN dataset, which is weekly
...
##--num_weather_vars 6 --soil_depths 10 --num_soil_vars 10 --num_extra_vars 4 --no_management --combine_weather_and_management
