...
if args.crop_type not in args.dataset:
    ...
    exit(1)
##--crop_type soybeans --dataset soybeans --data_dir ../data/old-cnnrnn-data/soybean_data_full.npz -adj ../map/us_adj.pkl --crop_id_to_fid ../map/soybean_fid_dict.pkl --mode train --model cnn_rnn --scheduler step --batch_size 16 --num_weather_vars 6 --soil_depths 10 --num_soil_vars 10 --num_extra_vars 4 --no_management --combine_weather_and_management
...
elif "weekly" in args.data_dir or args.data_dir.endswith(".npy") or "soybean_data_full.npz" in args.data_dir:  # A bit of a hack to accomodate the previous paper's CNN-RNN dataset, which is weekly
